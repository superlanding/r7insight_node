...
var Logger = function (_Writable) {
  ...
  function Logger(opts) {
    ...
    if (_lodash2.default.isUndefined(opts.region) && _lodash2.default.isUndefined(opts.host)) {
      throw new _error.BadOptionsError(opts, _text2.default.noRegion(opts.region));
    }

    if (!_lodash2.default.isUndefined(opts.region) && !_lodash2.default.isUndefined(opts.host)) {
      throw new _error.BadOptionsError(opts, _text2.default.noRegionAndHost(opts.region));
    }
    ...
    _this.host = opts.host || opts.region + '.' + (opts.baseHost || defaults.baseHost);
